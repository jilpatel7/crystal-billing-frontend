...
import { ChevronLeft, ChevronRight, Calendar, Clock, UserCheck, UserX, UserMinus } from 'lucide-react';
          ...
          return (
            <button
              ...
              className={`
                ...
                ${attendance ? getStatusColor(attendance.status) : 'bg-gray-50 border-gray-200 hover:bg-gray-100'}
              `}
            >
