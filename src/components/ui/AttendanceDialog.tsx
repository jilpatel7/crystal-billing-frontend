...
import { AttendanceFormData, attendanceSchema } from '../../features/staff/validation-schema/attendanceSchema';
...
const AttendanceDialog: React.FC<AttendanceDialogProps> = ({
  ...
  const requiresReason = watchedStatus === AttendanceStatus.ABSENT || watchedStatus === AttendanceStatus.HALF_DAY;
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Mark attendance for {staffMember.first_name} {staffMember.last_name} on{' '}
