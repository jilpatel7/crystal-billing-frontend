...
export const attendanceSchema = z.object({
  ...
  if (data.status === AttendanceStatus.ABSENT || data.status === AttendanceStatus.HALF_DAY) {
...
export const leaveRequestSchema = z.object({
  ...
  return data.status === AttendanceStatus.ABSENT || data.status === AttendanceStatus.HALF_DAY;
}, {
